                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${lstEmployee}" var="x">
                                                    <tr>
                                                        ...
                                                        <td>${x.getNgayTao()}</td>
                                                        <td>
                                                            <button type="button" onclick="openedit('${x.getTen()}', '${x.getSdt()}', '${x.getEmail()}', '${x.getDiaChi()}', '${x.getVaiTro()}', '${x.getNgayTao()}', '${x.getId()}')" name="suaNV" class="btn btn-primary"><i class="fa fa-edit" title="sửa"></i></button>
                                                            <button type="button" onclick="confirmremove('${x.getId()}')" name="xoaNV" class="btn btn-danger"><i class="fa fa-trash" title="xóa"></i></button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>     
                                            <div hidden><%= i = 1%></div>
