    ...
    <body class="hold-transition sidebar-mini">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="pull-right" style="text-align: right;">
                                            <button type="button" class="btn btn-success" id="btnAdd" name="btnAdd"  onclick="openadd()">
                                                ...
                                                <c:forEach items="${lstCategory}" var="x">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" onclick="confirmremove('${x.getId()}')" class="btn btn-danger" name = "xoaCate"><i class="fa fa-trash" title="xóa"></i></button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>     
                                            <div hidden><%= i = 1%></div>
                    ...
                    <form method="get" action="ThemSP">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtGhiChu" name="txtGhichu" placeholder="Ghi Chú" required>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="card-header">
                        <h3 class="card-title">Xóa sản phẩm</h3>
                    </div>
                    <form method="get" action="XoaSP">
                        ...
                        <div class="modal-footer" style="text-align: center;display: block;">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                            <button type="submit" class="btn btn-primary" name = "btnConfirm">Xác Nhận</button>
                        </div>
                    </form>
                </div>
            </div>
